<template>
  <div class="container">
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm"
      ...
      <el-form-item>
        <el-upload class="upload-demo" action="" :on-remove="handleRemove" :file-list="fileUpLoad.fileList"
          list-type="picture">
...
el-icon-s-opportunity"> </i>
      ...
      <el-dialog title="付款方式" :visible.sync="payment" width="70%" center>
        <center>
          ...
          <hr>
          <button class="pay_btn" @click="dopay('alipay')"><img height='70%' width="10%" src="@/assets/alipay.png"
              alt=""><span>支付宝</span></button>
          <button class="pay_btn" @click="dopay('wxpay')"><img height='70%' width="10%" src="@/assets/wxpay.png"
