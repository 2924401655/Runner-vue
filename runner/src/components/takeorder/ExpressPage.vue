<template>
  <div class="container">
    ...
    <h2 style="text-align:center"> 快递代取业务下单页</h2>
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm"
      ...
      <el-form-item label="期望收货地">
        <div class="block">
          ...
          <el-cascader v-model="Cascader.selectedValue" :options="options"></el-cascader>
        </div>
      </el-form-item>
      ...
      <el-form-item label="身份码">
        <el-upload class="upload-demo" action="/" :file-list="fileUpLoad.fileList" list-type="picture" accept="image/*">
      ...
      <el-form-item>
        <el-card class="text-card">
          ...
          <span>备注信息在抢单大厅所有人不可见,仅备注信息所有人可见</span>
        </el-card>
      </el-form-item>
      <el-form-item>
      ...
      <el-dialog title="付款方式" :visible.sync="payment" width="70%" center>
        <center>
          <hr>
          <span class="money">￥{{ totalAmount }}</span>
          <hr>
          <button class="pay_btn" @click="dopay('zfb')"><img height='70%' width="10%" src="@/assets/alipay.png"
              alt=""><span>支付宝</span></button>
          <button class="pay_btn" @click="dopay('wx')"><img height='70%' width="10%" src="@/assets/wxpay.png"
              alt=""><span>微信支付</span></button>
          <p><strong>订单已保存至</strong><a style='text-decoration: none;color: #4C33E5;font-weight: 800'
              href="/User/orderlist">[订单列表]</a></p>
